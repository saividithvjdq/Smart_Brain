...
interface StateIconProps {
    ...
    className?: string;
    duration?: number;
    forceState?: "default" | "active";
}

function useAutoToggle(interval: number, forceState?: "default" | "active") {
    const [on, setOn] = useState(forceState === "active");

    useEffect(() => {
        if (forceState !== undefined) {
            setOn(forceState === "active");
            return;
        }
...
export function SuccessIcon({ size = 40, color = "currentColor", className, duration = 2200, forceState }: StateIconProps) {
    const done = useAutoToggle(duration, forceState);
    return (
...
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, forceState }: StateIconProps) {
    const open = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
/* ─── 3. PLAY → PAUSE ─── */
export function PlayPauseIcon({ size = 40, color = "currentColor", className, duration = 2400, forceState }: StateIconProps) {
    const playing = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, forceState }: StateIconProps) {
    const unlocked = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, forceState }: StateIconProps) {
    const copied = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, forceState }: StateIconProps) {
    const notif = useAutoToggle(duration, forceState);
    return (
...
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000, forceState }: StateIconProps) {
    const filled = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
            <motion.path
                d="M20 34s-12-7.5-12-16a7.5 7.5 0 0112-6 7.5 7.5 0 0112 6c0 8.5-12 16-12 16z"
                stroke={filled ? "#B638FF" : color} // Axon brand color instead of red
                strokeWidth={2}
                fill={filled ? "#B638FF" : "none"}
...
export function DownloadDoneIcon({ size = 40, color = "currentColor", className, duration = 2400, forceState }: StateIconProps) {
    const done = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, forceState }: StateIconProps) {
    const sent = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
            <motion.g
                animate={sent
...
export function ToggleIcon({ size = 40, color = "currentColor", className, duration = 1800, forceState }: StateIconProps) {
    const on = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function EyeToggleIcon({ size = 40, color = "currentColor", className, duration = 2200, forceState }: StateIconProps) {
    const hidden = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function VolumeIcon({ size = 40, color = "currentColor", className, duration = 2400, forceState }: StateIconProps) {
    const muted = useAutoToggle(duration, forceState);
    return (
        <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
